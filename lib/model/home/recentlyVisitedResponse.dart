...
//
//     final recentlyVisitedResponse = recentlyVisitedResponseFromJson(jsonString);

import 'dart:convert';

RecentlyVisitedResponse recentlyVisitedResponseFromJson(String str) => RecentlyVisitedResponse.fromJson(json.decode(str));

String recentlyVisitedResponseToJson(RecentlyVisitedResponse data) => json.encode(data.toJson());

class RecentlyVisitedResponse {
  List<Datum> data;
  bool success;
  ...
  factory RecentlyVisitedResponse.fromJson(Map<String, dynamic> json) => RecentlyVisitedResponse(
