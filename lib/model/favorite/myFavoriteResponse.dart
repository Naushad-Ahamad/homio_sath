...
MyFavoriteResponse myFavoriteResponseFromJson(String str) => MyFavoriteResponse.fromJson(json.decode(str));

String myFavoriteResponseToJson(MyFavoriteResponse data) => json.encode(data.toJson());
...
class MyFavoriteResponse {
  ...
  factory MyFavoriteResponse.fromJson(Map<String, dynamic> json) => MyFavoriteResponse(
